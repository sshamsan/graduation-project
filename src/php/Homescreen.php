...
$Ttime = $_POST['time'];
$res;
$res = mysqli_query($con, "INSERT INTO constfiles (patientName , Phone_Number, Therapist , Consult_Date,Consult_Time)
VALUES ('$Name','$Phone_Number',$Therapist,'$ConsultDate','$Ttime') ");
if ($res == 1) {
    print_r($_POST);
  echo  
  '   
...
VALUES ('$Therapist','$Payment_Status','$Time','$Date','$file_num','$emp_id')");
if ($res == 1) {
  echo  
  '   
      <script>
    ...
    <div class="main">
        ...
        <div class="cointainer" style="padding-right: 300px; padding-left: 300px; padding-top: 20px;">
            ...
            <div class="widgets d-flex flex-column">
                ...
                <div>
                    <button type="button" class="btn btn-danger">Total no-shows: 3</button>
                            ...
                            <div class="modal-body">
                                <form class="popupwindow" method="post">
                                    ...
                                    <select name="therapist"class="form-select" aria-label="Default select example">
                                        ...
                                        <option value="112">Therapist 1</option>
                                        <option value="123">Therapist 2</option>
                                        <option value="3">Therapist 3</option>
                                    </select>
                                    <input name="date" class="form-control" type="date" placeholder="Date">
                                    <input name="time" class="form-control" type="time" min="08:00" max="17:00"placeholder="Time">
