          ...
          <div class="pricing-column col-lg-2 col-md-2">
            <div class="card">
              ...
              <div class="card-body">
                ...
                <button type="submit" name='id'  class="sumbitbutton btn btn-success"><a style="color: black; text-decoration: none;" href=http://localhost/graduation-project/src/php/PatientData-therapist.php?id=<?=$row['File_Number'] ?>>Show File</a></button>
                <!-- </form> -->
