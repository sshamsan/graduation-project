                    ...
                    <button type="button" class="btn" data-dismiss="modal"><i
                      ...
                      <div class="modal-body">
                        ...
                        <form class="popupwindow">
                          <input class ="inputb" type="text" placeholder="   Name">
                          <input  class ="inputb" type="text" placeholder="   Email">
                        ...
                        <input class ="inputb inputbottom" type="text" placeholder="   Specialization">
