...
if (isset($_POST['Emp'])) {
$Name = $_POST['name'];
$Emp_ID = $_POST['Emp_ID'];// make it generated by the sql table
...
$res;
$res = mysqli_query($con, "INSERT INTO employee (Employee_ID , Name , Role , Specialization,password,Hired_date,Department_ID,employee_email)
VALUES ('$Emp_ID','$Name','$role','$specilization','$encpt_password','$Hired_Date','$Dep_ID','$Emp_email') ");
if ($res == 1) {
                    ...
                    <button type="button" class="btn" data-dismiss="modal"><i
                      ...
                      <div class="modal-body">
                        ...
                        <form class="popupwindow"method="post">
                          ...
                          <input name="Emp_ID"type="text" placeholder=""><br><br>
